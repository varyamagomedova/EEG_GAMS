...
coords <- as_tibble(data.table::fread('r_channel_positions.txt',
                                      col.names = c('channel', 
                                               'hem','reg','z')))
#Insert citations for subdivisions
channel_groups <- list(
  #tons of face movement artifats here
  Prefrontal = c( "Fz", "Fp1", "Fp2", "AFp1", "AFp2", "AF3", "AF4", "AF7", "AF8", "AFF1h", "AFF2h", "AFF5h", "AFF6h"),
  Frontal = c("F1", "F2", "F3", "F4", "F5", "F6",  "F9", "F10","Fz", "FCz"),
  ...
  #but also some artifacts here - include Broca's area here
  FLateral= c("FC5", "FC6","FT9", "FT10","F7", "F8","FFT7h",  "FFT8h","F9", "F10","FFT10h",  "FFT9h"),
  FTemporal = c("T7", "T8","FT7", "FT8",  "TP7", "TP8", "TP9", "TP10", "FTT7h", "FTT8h", "FTT9h", "FTT10h"),
  PTemporal = c("TP7", "TP8", "TP9", "TP10", "TPP7h", "TPP8h", "TPP9h", "TPP10h", "TTP7h", "TTP8h", "TTP9h", "TTP10h"),
  #subdivide parietal. more
  CParietal =c("Cz","CPz" ,"CP1", "CP2", "CP3", "P2", "P3", "P4", "CP4", "CP5", "CP6", "CPP1h", "CPP2h", "CPP3h", "CPP4h", "CPP5h", "CPP6h"),
  Narrow_CentralParietal = c("P2", "P3", "P4", "CP4", "C3", "CP1", "Cz", "Pz"),
  Parietal = c("Pz","P1", "P2", "P3", "P4", "P5", "P6", "P7", "P8", "P9", "P10",  "PPO10h" ,"PPO1h" , "PPO2h" , "PPO5h",  "PPO6h",  "PPO9h"),
  Occipital = c("O1", "O2", "O9", "O10","OI1h" , "Oz", "OI2h", "POz", "PO3", "PO4", "PO7", "PO8", "PO9", "PO10", "POO1", "POO2", "POO9h", "POO10h"),
  NoHem = c("Iz", "AFz", "Fz", "FCz", "Pz", "POz","Fpz","Oz")
)
